...
1. Download
   ```shell
   curl -sfL https://github.com/SuperioOne/nut_webgui/releases/download/v0.8.1/install.sh -o install.sh
   ```
2. **REVIEW**
   ```shell
   less ./install.sh
...
Or pipe curl output into `sh` directly (* *Insert Michael worried meme here* *):
 ```shell
curl -sfL https://github.com/SuperioOne/nut_webgui/releases/download/v0.8.1/install.sh | sh -
```
...
### (Optional) Custom target
   ...
   ```shell
   curl -sfL https://github.com/SuperioOne/nut_webgui/releases/download/v0.8.1/install.sh | NUTWG_TARGET="x86-64-v3-musl" sh -
   ```
...
```shell
curl -sfL https://github.com/SuperioOne/nut_webgui/releases/download/v0.8.1/PKGBUILD -o PKGBUILD
makepkg -i
```
